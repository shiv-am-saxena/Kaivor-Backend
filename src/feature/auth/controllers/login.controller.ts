...
export const googleLoginCallback = asyncHandler(async (req: Request, res: Response, next: NextFunction) => {
...
export const loginWithEmail = asyncHandler(async (req: Request, res: Response) => {
    ...
    if(!user.isVerified.email) {
        throw new ApiError(403, "Email is not verified. Please verify your email before logging in.");
    }
	const accessToken = generateAccessToken({ _id: user._id, email: user.email });
    const refreshToken = generateRefreshToken({ _id: user._id, email: user.email });
...
export const resendVerificationEmail = asyncHandler(async (req: Request, res: Response) => {
    ...
    res.status(200).json(new ApiResponse(200, null, "Verification email resent successfully. Please check your email."));
});
...
export const forgotPassword = asyncHandler(async (req: Request, res: Response) => {
	...
	res.status(200).json(new ApiResponse(200, null, "Password reset email sent successfully. Please check your email."));
});
...
export const resetPassword = asyncHandler(async (req: Request, res: Response) => {
	...
	if(!newPassword || !cnfNewPassword || typeof newPassword !== "string" || typeof cnfNewPassword !== "string") {
